...
const RSSFeedButton = (props: { className?: string }) => {
  return (
    <LinkButton
      title={"RSS Feed"}
      href={"/feed.xml"}
      ...
      className={cx(
        "self-start pr-3.5",
        "text-dark/85 hocus:text-dark",
        "bg-orange-500",
        "hocus:bg-orange-400",
        "ring-orange-600 dark:ring-orange-600",
        "hocus:ring-orange-500 dark:hocus:ring-orange-500",
        props.className,
      )}
