...
export const NowPlayingLink = twc(Link)`
  font-normal
...
export const NowPlayingAlbumCover = twc(Img)`
  size-6 rounded-full
...
export const NowPlayingTextsContainer = twc.div`
...
export const ScrollingText = twc.span`
